...
class ReactivateStaffRequest extends FormRequest
{
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator): void {
            ...
            if (! in_array($staff->status, [Staff::STATUS_SUSPENDED, Staff::STATUS_INACTIVE], true)) {
                $validator->errors()->add('status', 'Only suspended or inactive staff can be reactivated.');
            }
        });
    }
}
